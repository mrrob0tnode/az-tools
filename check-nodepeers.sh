...
pushover() {
    msg=$(echo -e "🧅 <b>Checking $NODE Peers</b>\n$1")
    curl -s \
    -d parse_mode="HTML" \
    -d text="$msg" \
    -d chat_id="$CHATID" \
...
echo "$count_msg1"
count_msg2="Hybrid nodes: $hybrid_count"
echo "$count_msg2"
count_msg3="Successfully switched to clearnet: $attempt_successful_count"
echo "$count_msg3"
count_msg4="Clearnet only nodes: $clearnet_only_count"
echo "$count_msg4"
count_msg5="Tor only nodes: $tor_only_count"
echo "$count_msg5"
count_msg6="Tor exit through clearnet: $tor_only_exit_clear_count"
echo "$count_msg6"
count_msg7="Active channels: $active_channels"
echo "$count_msg7"
count_msg8="Inactive channels: $inactive_count"
echo "$count_msg8"
count_msg9="Successfully reconnected: $reconnected_inactive_count"
echo "$count_msg9"
